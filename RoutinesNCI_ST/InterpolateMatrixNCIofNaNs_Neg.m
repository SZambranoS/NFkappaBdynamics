function [matrixinterp] = InterpolateMatrixNCIofNaNs_Neg(matrixtointerp)

%This works when the matrix of NCIs has some negative numbers, which is not
%good. 

matrixtointerp(matrixtointerp<0)=NaN; 
