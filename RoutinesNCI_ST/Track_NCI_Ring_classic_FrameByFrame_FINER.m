function [LabelsMap, cellROIs_refined,refinedmask,roughmask] = Track_NCI_Ring_classic_FrameByFrame_FINER(StackTrack,StackQuant, parCellTrack, filenameprint, filenamesave, shallweplot,pathoutput)
