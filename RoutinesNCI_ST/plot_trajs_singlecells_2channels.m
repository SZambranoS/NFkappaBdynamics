function plot_trajs_singlecells_2channels(StackTrack,StackBG,namefiletracks,filetrackfolder)
...
hFrameSlider = uicontrol( ...
    ...
    'Callback', @(src, evt) changeFrame(hStackTrack, hPlot, get(src, 'Value'), ...
     StackTrack, StackBG, nFrames,matricesofX,matricesofY,limitstouse,points));
...
redSlice = StackBG(iFrame).data;
greenSlice = StackTrack(iFrame).data;
