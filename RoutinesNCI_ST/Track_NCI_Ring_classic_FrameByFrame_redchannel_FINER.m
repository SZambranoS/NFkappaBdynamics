function [LabelsMap, cellROIs_refined,refinedmask,roughmask] = Track_NCI_Ring_classic_FrameByFrame_redchannel_FINER(StackTrack,StackQuant, StackRed, parCellTrack, filenameprint, filenamesave, shallweplot,pathoutput)
